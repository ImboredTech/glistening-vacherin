...
//STANDARD - disable right click on game pages as rmb not needed there
//////////
//disable rmb on loader page
console.log("disabling right click on loader page...");
...
//if (Math.random() < 0.1) { //10%
    ...
    console.log("disabling right clicks on inner game page...");
